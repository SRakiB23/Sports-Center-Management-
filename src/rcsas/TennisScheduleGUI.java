 ...
 * @author sazza
 */
public class TennisScheduleGUI extends javax.swing.JFrame {

    /**
     * Creates new form TennisScheduleGUI
     */
    public TennisScheduleGUI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        SwimmingTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                ...
                {"10:30am - 12:30pm", "         ", "        ", "         Available", "         Available", "         ", "         Available", "         Available"},
                {"2:00pm - 4:00pm", "         Available", "         Available", "         ", null, "         Available", "       ", "         Available"},
                {"4:30pm - 6:30pm", "         Available", "         ", "         Available", "         Available", "         Available", "         Available", "         "}
            },
            new String [] {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TennisScheduleGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TennisScheduleGUI().setVisible(true);
            }
        });
    }
