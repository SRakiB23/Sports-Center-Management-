 ...
 * @author user
 */
public class ArcheryScheduleGUI extends javax.swing.JFrame {

    /**
     * Creates new form SwimmingScheduleGUI
     */
    public ArcheryScheduleGUI() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ArcheryScheduleGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ArcheryScheduleGUI().setVisible(true);
            }
        });
    }
