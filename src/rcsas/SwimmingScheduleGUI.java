 ...
 * @author user
 */
public class SwimmingScheduleGUI extends javax.swing.JFrame {

    /**
     * Creates new form SwimmingScheduleGUI
     */
    public SwimmingScheduleGUI() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SwimmingScheduleGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SwimmingScheduleGUI().setVisible(true);
            }
        });
    }
