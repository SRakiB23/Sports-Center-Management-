 ...
 * @author user
 */
public class BadmintonScheduleGUI extends javax.swing.JFrame {

    /**
     * Creates new form SwimmingScheduleGUI
     */
    public BadmintonScheduleGUI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        SwimmingTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"8:00am - 10:00am", "", "", "         Available", "         Available", "         Available", "", null},
                {"10:30am - 12:30pm", "         Available", "         Available", "", null, "         Available", "", "         Available"},
                {"2:00pm - 4:00pm", "         Available", "         Available", "         Available", "         Available", null, "         Available", "         Available"},
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BadmintonScheduleGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BadmintonScheduleGUI().setVisible(true);
            }
        });
    }
