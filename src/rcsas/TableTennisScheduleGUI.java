 ...
 * @author sazza
 */
public class TableTennisScheduleGUI extends javax.swing.JFrame {

    /**
     * Creates new form TableTennisScheduleGUI
     */
    public TableTennisScheduleGUI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        SwimmingTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"8:00am - 10:00am", "         Available", "         ", "         ", "         Available", "         Available", "         Available", "         "},
                {"10:30am - 12:30pm", "         ", "         Available", "         ", "         Available", "         ", "         ", "         Available"},
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TableTennisScheduleGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TableTennisScheduleGUI().setVisible(true);
            }
        });
    }
