 ...
 * @author sazza
 */
public class VolleyballScheduleGUI extends javax.swing.JFrame {

    /**
     * Creates new form VollyballScheduleGUI
     */
    public VolleyballScheduleGUI() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VolleyballScheduleGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VolleyballScheduleGUI().setVisible(true);
            }
        });
    }
